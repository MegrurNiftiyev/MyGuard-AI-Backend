...
## 📊 Real Dataset Training & Evaluation Report

**Technologies Used**: TensorFlow / Keras (RETVec + 1D CNN Architecture)  
...
**Held-Out Test Set**: 6 real-world document files reserved for zero-data-leakage testing.
